...
SRCS = main.c cat.c cd.c chmod.c clear.c diff.c ls.c mkdir.c mv.c pwd.c rmdir.c touch.c tree_io.c whereis.c
OBJS = $(SRCS:.c=.o)
DEPS = header.h tree_io.h cat.h cd.h chmod.h clear.h diff.h ls.h mkdir.h mv.h pwd.h rmdir.h touch.h whereis.h
...
main.o: main.c header.h tree_io.h cat.h cd.h chmod.h clear.h diff.h ls.h mkdir.h mv.h pwd.h rmdir.h touch.h whereis.h
	$(CC) $(CFLAGS) -c $< -o $@
